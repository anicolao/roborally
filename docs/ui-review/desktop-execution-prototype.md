...
registers. The older history disclosure and recent-move list are redundant on
desktop and are hidden there. Rules and race details remain available.
...
- The new arrangement applies above 1000px width and 560px height. Phone, tablet
  and short landscape layouts keep their existing arrangement; tabletop is
  unchanged.
...
This is a local prototype branch. Linux screenshot baselines and CI have not
been refreshed or validated for this follow-up.
