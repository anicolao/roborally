...
The Linux baseline workflow also passed ([run 34738045229](https://github.com/anicolao/roborally/actions/runs/34738045229)).
All 68 changed Linux screenshots were visually reviewed, including desktop
execution, decision panels, option inspection, and the catalog at each viewport.
These baselines are committed for the normal PR run to compare without updates.
