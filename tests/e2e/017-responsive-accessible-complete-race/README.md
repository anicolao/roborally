...
![The complete race begins with equivalent non-pointer and pointer controls](./screenshots/000-keyboard-touch-board-and-timer-controls-desktop.png)
...
![Submission exposes an equivalent textual deadline and state cue](./screenshots/001-textual-timer-and-non-color-state-desktop.png)
...
![The accessible production race reaches its immutable winner](./screenshots/002-responsive-race-reaches-three-flags-desktop.png)
